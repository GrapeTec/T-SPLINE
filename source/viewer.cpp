...
#include "gl.h"														    // Header File For The GL Basecode
#include "math.h"                                                      
#include "rotation.h"                                                    
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	window.init.title = "T-spline model";
				...
				while (isMessagePumpActive == TRUE)					// While The Message Pump Is Active
				{
					...
					else											// If There Are No Messages
					{
						...
						else										// If Window Is Visible
						{
							...
							std::string filename = "../rhino/";		// Path to the *.tsm file
							filename += lpCmdLine;					// Name of *.tsm file

							Draw(filename);							// Draw Our Scene
